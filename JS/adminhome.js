...
async function display() {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/user/get");
    if(resp.status==200){
...
async function delUser(id) {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/user/delete?id="+id,{
        method : "DELETE"
    });
...
async function checkRooms(){
    if (btn.value == "Update")
        ...
        let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/room/getByNo?num="+roomNo.value);
        if(resp.status==200){
...
async function addRooms() {
    ...
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/room/save",{
        method :'POST',
        headers : {
...
async function displayRooms() {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/room/get");
    if(resp.status==200){
...
async function delroom(id) {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/room/delete?id="+id,{
        method : "DELETE"
    });
    let msg = await resp.text();
    message(msg);
...
async function editroom(num) {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/room/getByNo?num="+num);
...
async function updateRooms(num) {
    ...
    if(resp.status==200){
        ...
        await fetch("http://localhost:8080/HotelManagementSystemMVC/room/update",{
        method :'POST',
        headers : {
            'Accept' : 'application/json',
            'Content-Type' : 'application/json'
...
async function displayApprove() {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/bookedRoom/get");
    if(resp.status==200){
...
async function approve(num) {
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/bookedRoom/getByNo?num="+num);
    let broom = await resp.json();
    let resp1 = await fetch("http://localhost:8080/HotelManagementSystemMVC/user/getByEmail?email="+broom.user);
    let user = await resp1.json();
    if (confirm("Approve Booking?.")) {
        broom.isApproved= true;
        await fetch("http://localhost:8080/HotelManagementSystemMVC/bookedRoom/update",{
              method :'POST',
              headers : {
                  'Accept' : 'application/json',
                  'Content-Type' : 'application/json'
        ...
        await fetch("http://localhost:8080/HotelManagementSystemMVC/user/update",{
            method :'POST',
            headers : {
                'Accept' : 'application/json',
                'Content-Type' : 'application/json'
