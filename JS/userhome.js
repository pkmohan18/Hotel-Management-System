...
async function insertData(){
    let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/user/getByEmail?email="+sessionStorage.getItem("email"));
...
async function updateProfile(){
    if(validation()){
        let resp = await fetch("http://localhost:8080/HotelManagementSystemMVC/user/getByEmail?email="+email.value);
        let user = await resp.json();
